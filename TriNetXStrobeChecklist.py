...
# ---- Full STROBE Checklist Items with customized sample comments ----
STROBE_ITEMS = [
    {
...
# ---- Now that STROBE_ITEMS is defined, initialize session state ----
...
with st.form("strobe_form"):
    ...
    for idx, item in enumerate(STROBE_ITEMS):
        ...
        with c3:
            ...
            # Update comment if the selected sample comment has changed
